       ...
       switch (MenuEncargadoDeposito.opcion){
          case 1:
               ...
               //  ProdSerEdit.list_categoriaPS.setSelectedItem(p.get(0).getCodigoCategoria());
                 ArticuloModif.combo_proveedor.setSelectedItem(a.get(0).getCodigoProveedor());
                 fr.setVisible(true);
           ...
           case 2:
                ...
                CantidadStock=(Integer)masterTable.getValueAt(fila, 2);
                cantidadMinima=(Integer)masterTable.getValueAt(fila, 3);
                prov=(String)masterTable.getValueAt(fila, 4);
                 ...
                 ArticuloEliminar.tf_codigoProveedor.setText(prov);
