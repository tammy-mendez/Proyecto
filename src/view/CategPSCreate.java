 ...
 * @author Jorge
 */
public class CategPSCreate extends javax.swing.JFrame {
    private char ch;
    private int resp;
    ...
    private void initComponents() {
        ...
        lbl_crearCPS.setText("Crear Categoría de Producto/Servicio");
    ...
    private void btn_guardarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btn_guardarActionPerformed
        // TODO add your handling code here:
         if (tf_nombreCateg.getText().length()==0){
                ...
                query.setParameter("nombre", tf_nombreCateg.getText().toLowerCase());
              ...
              resp=  JOptionPane.showConfirmDialog(null,"Desea Registrar una nueva Categoría de P/S?", "Confirmar Creación",JOptionPane.YES_NO_OPTION );
              if (resp==JOptionPane.YES_OPTION){
                        CategoriaProdSer ca=new CategoriaProdSer();
                        ca.setNombre(tf_nombreCateg.getText().toLowerCase());
                        ...
                        as.setTabla("Categoría de Producto/Servicio");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(CategPSCreate.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                JFrame frame=new CategPSCreate();
                frame.setVisible(true);
                frame.setTitle("Crear Categoría P/S");
