...
public class Proveedor implements Serializable {
   @Transient
    ...
    public Proveedor(Integer codigoProveedor, String tipo, String razonSocial, String ruc, String cedula, String email, String direccion, int telefono) {
        this.codigoProveedor = codigoProveedor;
        this.tipo = tipo;
 ...
 public String getRazonSocial(int codigo) {
        return razonSocial;
    }
  ...
  public int getTelefono() {
    ...
    public String toString() {
        return "view.Proveedor[ codigoProveedor=" + codigoProveedor + " ]";
    }
